...
<script src="/FarmStoryTeam2/js/validation.js"></script>
        ...
        <main>
            <div class="mainIn">
                <section class="register">
                    <form action="/FarmStoryTeam2/user/register.do" method="post">
                        <table border="1">
                        ...
                        <div>
                            <a href="/FarmStoryTeam2/user/login.do" class="btnCancel">취소</a>
